Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-example-app.com'
  config.app_name = 'Volt_example_app'
  config.mailer.from = 'Volt_example_app <no-reply@volt-example-app.com>'
  ...
  #
  config.app_secret = 'WAbjyq16TTCscP3NpNEovTsXb2l5lHlpefUe3tgLXwtAksxaccaVWd4pCqZd-h4AxB0'
